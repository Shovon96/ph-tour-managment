            ...
            <div className="mx-auto max-w-screen-xl px-4 pt-16 pb-8 sm:px-6 lg:px-8">
                ...
                <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
                    ...
                    <div className="mx-auto max-w-sm lg:max-w-none">
                        <p className="mt-4 text-center text-muted-foreground lg:text-left lg:text-lg">
                        ...
                        <div className="mt-6 flex justify-center gap-4 lg:justify-start">
                            <a className="text-muted-foreground transition hover:text-foreground" href="#" target="_blank" rel="noreferrer">
                    ...
                    <div className="grid grid-cols-1 gap-8 text-center lg:grid-cols-3 lg:text-left">
                        ...
                        <div>
                            ...
                            <ul className="mt-6 space-y-1">
                                <li><a className="text-muted-foreground transition hover:text-foreground" href="#">Marketing</a></li>
                                <li><a className="text-muted-foreground transition hover:text-foreground" href="#">Graphic Design</a></li>
                                <li><a className="text-muted-foreground transition hover:text-foreground" href="#">App Development</a></li>
                                <li><a className="text-muted-foreground transition hover:text-foreground" href="#">Web Development</a></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="mt-6 space-y-1">
                                <li><a className="text-muted-foreground transition hover:text-foreground" href="#">About</a></li>
                                <li><a className="text-muted-foreground transition hover:text-foreground" href="#">Careers</a></li>
                                <li><a className="text-muted-foreground transition hover:text-foreground" href="#">History</a></li>
                                <li><a className="text-muted-foreground transition hover:text-foreground" href="#">Our Team</a></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="mt-6 space-y-1">
                                <li><a className="text-muted-foreground transition hover:text-foreground" href="#">FAQs</a></li>
                                <li><a className="text-muted-foreground transition hover:text-foreground" href="#">Contact</a></li>
                                <li><a className="text-muted-foreground transition hover:text-foreground" href="#">Live Chat</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-16 border-t border-border pt-8">
                    <p className="text-center text-xs text-muted-foreground">
                        © DESH TRAVEL 2025. All rights reserved.
                        <br /></p>
                </div>
            </div>
        </footer>
